 ...
 open class CycleScrollView: UIView,UICollectionViewDelegate,UICollectionViewDataSource,UIScrollViewDelegate {
    ...
    override open func layoutSubviews() {
        ...
        if mainView?.contentOffset.x == 0 && totalItemsCount > 0 {
            ...
            mainView?.scrollToItem(at: IndexPath.init(row: targetIndex, section: 0), at: UICollectionView.ScrollPosition.left, animated: false)
        }
    ...
    func scrollToIndex(_ index : inout Int) {
        if index >= totalItemsCount {
            ...
            if options.scrollDirection == UICollectionView.ScrollDirection.horizontal {
                mainView.scrollToItem(at: IndexPath.init(row: index, section: 0) , at: UICollectionView.ScrollPosition.left, animated: false)
            }else {
                mainView.scrollToItem(at: IndexPath.init(row: index, section: 0) , at: UICollectionView.ScrollPosition.top, animated: false)
            }
        }
        if options.scrollDirection == UICollectionView.ScrollDirection.horizontal {
            mainView.scrollToItem(at: IndexPath.init(row: index, section: 0) , at: UICollectionView.ScrollPosition.left, animated: true)
        }else {
            mainView.scrollToItem(at: IndexPath.init(row: index, section: 0) , at: UICollectionView.ScrollPosition.top, animated: true)
        }
    }
...
extension CycleScrollView{
    public func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if options.scrollDirection == UICollectionView.ScrollDirection.vertical {
