...
/// Style
public enum EnumPageControlStyle {
    case none
    case system
    case fill
    case pill
...
open class LLCycleScrollView: UIView {
    ...
    /// Radius [EnumPageControlStyle == .fill]
    ...
    /// Active Tint Color [EnumPageControlStyle == .pill || EnumPageControlStyle == .snake]
    ...
    /// Active Image [EnumPageControlStyle == .system]
    ...
    /// In Active Image [EnumPageControlStyle == .system]
    ...
    open var customPageControlStyle: EnumPageControlStyle = .system {
        didSet {
            setupPageControl()
        }
    }
